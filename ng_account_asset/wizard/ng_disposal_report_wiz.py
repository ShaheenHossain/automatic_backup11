...
class disposal_report(models.TransientModel):
    ...
    date1 = fields.Date(string="Start Date", required=True, default=time.strftime('%Y-%m-%d'))
    date2 = fields.Date(string="End Date", required=True, default=time.strftime('%Y-%m-%d'))
